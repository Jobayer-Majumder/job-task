    ...
    return (
        <>
            <div className="col mb-3">
                <div className="card card-bg custom-radius">
                    ...
                    <div className="card-footer custom-card-footer d-flex justify-content-between pb-3">
                        <a href="/" className='text-decoration-none nunito-font fw-bold'>More Info <BsArrowRight className='fs-2'/></a>
                        <span className='fs-4' style={{color: '#CC3CC9'}}><AiOutlineDatabase /></span>
                    </div>
                </div>
            </div>
        </>
